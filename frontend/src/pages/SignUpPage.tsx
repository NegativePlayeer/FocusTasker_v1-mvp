                ...
                >
                    <div
                        ...
                        <div className="mb-6 text-center">
                            ...
                            <p className="text-sm text-slate-400 dark:text-slate-500 mt-1">Your calm space to get things
                                done</p>
                        </div>
                        ...
                        <div
                            className="w-full max-w-sm bg-white dark:bg-slate-900 rounded-2xl p-8 border border-slate-100 dark:border-slate-800 shadow-sm">
                            <div className="flex items-center justify-between mb-6">
                                <h2 className="text-lg font-medium text-slate-700 dark:text-slate-200">Create your
                                    account</h2>
                            ...
                            <form onSubmit={handleSignUp} className="flex flex-col gap-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-sm text-slate-500 dark:text-slate-400"
                                               htmlFor="confirm-password">Confirm</label>
                                        <Input
                                            id="confirm-password"
                                            type="password"
                                ...
                                <div className="flex flex-col gap-2 mt-2">
                                    ...
                                    <Button
                                        type="submit"
                                        className="h-11 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl cursor-pointer"
                                    >
                                        Sign up
                                    </Button>
                                </div>
            ...
            {step === 2 && (
                ...
                >
                    <div
                        ...
                        <div
                            className="w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl p-8 border border-slate-100 dark:border-slate-800 shadow-sm">
                            <h2 className="text-lg font-medium text-slate-700 dark:text-slate-200! mb-1">Your focus
                                profile</h2>
                            <p className="text-sm text-slate-400 dark:text-slate-500 pb-2">Select what describes you
                                best. You can change this later.</p>

                            <div className="flex flex-col gap-8">
                                <div>
                                    <p className="text-xs font-semibold uppercase tracking-wide text-slate-400 dark:text-slate-500 mb-3">My
                                        struggles</p>
                            ...
                            <div className="flex gap-3 mt-8">
                                <Button
                                    variant="outline"
                                    className="h-11 min-w-24 cursor-pointer rounded-xl border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300"
                                    onClick={() => setStep(1)}
                                >
                                    ← Back
                                </Button>
                                ...
                                <Button
                                    className="flex-1 h-11 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl cursor-pointer"
